...
export declare namespace integrations_v1alpha {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listTaskEntities(params: Params$Resource$Projects$Locations$Listtaskentities, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listTaskEntities(params?: Params$Resource$Projects$Locations$Listtaskentities, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>;
        listTaskEntities(params: Params$Resource$Projects$Locations$Listtaskentities, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        listTaskEntities(params: Params$Resource$Projects$Locations$Listtaskentities, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>): void;
        listTaskEntities(params: Params$Resource$Projects$Locations$Listtaskentities, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>): void;
        listTaskEntities(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Listtaskentities extends StandardParameters {
        /**
         * Required. The location resource of the request. This is not going to be used but preserve the field for future.
         */
        parent?: string;
    ...
    export class Resource$Projects$Locations$Integrations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Integrations$Monitorexecutionstats, options: StreamMethodOptions): GaxiosPromise<Readable>;
        monitorexecutionstats(params?: Params$Resource$Projects$Locations$Integrations$Monitorexecutionstats, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>;
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Integrations$Monitorexecutionstats, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Integrations$Monitorexecutionstats, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>): void;
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Integrations$Monitorexecutionstats, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>): void;
        monitorexecutionstats(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Integrations$Monitorexecutionstats extends StandardParameters {
        /**
         * Required. The parent resource name: {parent=projects/x/locations/x\}.
         */
        parent?: string;
    ...
    export class Resource$Projects$Locations$Integrations$Versions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        archive(params: Params$Resource$Projects$Locations$Integrations$Versions$Archive, options: StreamMethodOptions): GaxiosPromise<Readable>;
        archive(params?: Params$Resource$Projects$Locations$Integrations$Versions$Archive, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>;
        archive(params: Params$Resource$Projects$Locations$Integrations$Versions$Archive, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        archive(params: Params$Resource$Projects$Locations$Integrations$Versions$Archive, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>): void;
        archive(params: Params$Resource$Projects$Locations$Integrations$Versions$Archive, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>): void;
        archive(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deactivate(params: Params$Resource$Projects$Locations$Integrations$Versions$Deactivate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        deactivate(params?: Params$Resource$Projects$Locations$Integrations$Versions$Deactivate, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>;
        deactivate(params: Params$Resource$Projects$Locations$Integrations$Versions$Deactivate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        deactivate(params: Params$Resource$Projects$Locations$Integrations$Versions$Deactivate, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>): void;
        deactivate(params: Params$Resource$Projects$Locations$Integrations$Versions$Deactivate, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>): void;
        deactivate(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        validate(params: Params$Resource$Projects$Locations$Integrations$Versions$Validate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        validate(params?: Params$Resource$Projects$Locations$Integrations$Versions$Validate, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>;
        validate(params: Params$Resource$Projects$Locations$Integrations$Versions$Validate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        validate(params: Params$Resource$Projects$Locations$Integrations$Versions$Validate, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>): void;
        validate(params: Params$Resource$Projects$Locations$Integrations$Versions$Validate, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>): void;
        validate(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Integrations$Versions$Archive extends StandardParameters {
        /**
         * Required. The version to archive. Format: projects/{project\}/integrations/{integration\}/versions/{version\}
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Integrations$Versions$Deactivate extends StandardParameters {
        /**
         * Required. The version to deactivate. Format: projects/{project\}/integrations/{integration\}/versions/{version\}
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Integrations$Versions$Validate extends StandardParameters {
        /**
         * Required. The version to validate. Format: projects/{project\}/integrations/{integration\}/versions/{version\}
         */
        name?: string;
    ...
    export class Resource$Projects$Locations$Products {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createBundle(params: Params$Resource$Projects$Locations$Products$Createbundle, options: StreamMethodOptions): GaxiosPromise<Readable>;
        createBundle(params?: Params$Resource$Projects$Locations$Products$Createbundle, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaCreateBundleResponse>;
        createBundle(params: Params$Resource$Projects$Locations$Products$Createbundle, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createBundle(params: Params$Resource$Projects$Locations$Products$Createbundle, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaCreateBundleResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaCreateBundleResponse>): void;
        createBundle(params: Params$Resource$Projects$Locations$Products$Createbundle, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaCreateBundleResponse>): void;
        createBundle(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaCreateBundleResponse>): void;
        /**
         * This is a UI only method and will be moved away. Returns a list of common tasks.
         * @example
         * ```js
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listTaskEntities(params: Params$Resource$Projects$Locations$Products$Listtaskentities, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listTaskEntities(params?: Params$Resource$Projects$Locations$Products$Listtaskentities, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>;
        listTaskEntities(params: Params$Resource$Projects$Locations$Products$Listtaskentities, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        listTaskEntities(params: Params$Resource$Projects$Locations$Products$Listtaskentities, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>): void;
        listTaskEntities(params: Params$Resource$Projects$Locations$Products$Listtaskentities, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>): void;
        listTaskEntities(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Products$Createbundle extends StandardParameters {
        /**
         * Required. The location resource of the request.
         */
        parent?: string;
    ...
    export interface Params$Resource$Projects$Locations$Products$Listtaskentities extends StandardParameters {
        /**
         * Required. The location resource of the request. This is not going to be used but preserve the field for future.
         */
        parent?: string;
    ...
    export class Resource$Projects$Locations$Products$Integrations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        archiveBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Archivebundle, options: StreamMethodOptions): GaxiosPromise<Readable>;
        archiveBundle(params?: Params$Resource$Projects$Locations$Products$Integrations$Archivebundle, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaArchiveBundleResponse>;
        archiveBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Archivebundle, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        archiveBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Archivebundle, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveBundleResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveBundleResponse>): void;
        archiveBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Archivebundle, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveBundleResponse>): void;
        archiveBundle(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveBundleResponse>): void;
        /**
         * Executes integrations synchronously by passing the trigger id in the request body. The request is not returned until the requested executions are either fulfilled or experienced an error. If the integration name is not specified (passing `-`), all of the associated integration under the given trigger_id will be executed. Otherwise only the specified integration for the given `trigger_id` is executed. This is helpful for execution the integration from UI.
         * @example
         * ```js
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Products$Integrations$Monitorexecutionstats, options: StreamMethodOptions): GaxiosPromise<Readable>;
        monitorexecutionstats(params?: Params$Resource$Projects$Locations$Products$Integrations$Monitorexecutionstats, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>;
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Products$Integrations$Monitorexecutionstats, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Products$Integrations$Monitorexecutionstats, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>): void;
        monitorexecutionstats(params: Params$Resource$Projects$Locations$Products$Integrations$Monitorexecutionstats, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>): void;
        monitorexecutionstats(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaMonitorExecutionStatsResponse>): void;
        /**
         * Schedules an integration for execution by passing the trigger id and the scheduled time in the request body.
         * @example
    ...
    export interface Params$Resource$Projects$Locations$Products$Integrations$Archivebundle extends StandardParameters {
        /**
         * Required. The bundle to archive. Format: projects/{project\}/integrations/{integration\}
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Products$Integrations$Monitorexecutionstats extends StandardParameters {
        /**
         * Required. The parent resource name: {parent=projects/x/locations/x\}.
         */
        parent?: string;
    ...
    export class Resource$Projects$Locations$Products$Integrations$Executionsnapshots {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Products$Integrations$Executionsnapshots$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Products$Integrations$Executionsnapshots$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse>;
        list(params: Params$Resource$Projects$Locations$Products$Integrations$Executionsnapshots$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Products$Integrations$Executionsnapshots$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Products$Integrations$Executionsnapshots$List, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Products$Integrations$Executionsnapshots$List extends StandardParameters {
        /**
         * Currently supports filter by `execution_info_id` or `execution_snapshot_id`.
         */
        filter?: string;
    ...
    export class Resource$Projects$Locations$Products$Integrations$Versions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        archive(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Archive, options: StreamMethodOptions): GaxiosPromise<Readable>;
        archive(params?: Params$Resource$Projects$Locations$Products$Integrations$Versions$Archive, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>;
        archive(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Archive, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        archive(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Archive, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>): void;
        archive(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Archive, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>): void;
        archive(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse>): void;
        /**
         * Create a integration with a draft version in the specified project.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deactivate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Deactivate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        deactivate(params?: Params$Resource$Projects$Locations$Products$Integrations$Versions$Deactivate, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>;
        deactivate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Deactivate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        deactivate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Deactivate, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>): void;
        deactivate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Deactivate, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>): void;
        deactivate(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Getbundle, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getBundle(params?: Params$Resource$Projects$Locations$Products$Integrations$Versions$Getbundle, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaGetBundleResponse>;
        getBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Getbundle, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Getbundle, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaGetBundleResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaGetBundleResponse>): void;
        getBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Getbundle, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaGetBundleResponse>): void;
        getBundle(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaGetBundleResponse>): void;
        /**
         * Returns the list of all integration versions in the specified project.
         * @example
         * ```js
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Updatebundle, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateBundle(params?: Params$Resource$Projects$Locations$Products$Integrations$Versions$Updatebundle, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaUpdateBundleResponse>;
        updateBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Updatebundle, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Updatebundle, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaUpdateBundleResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaUpdateBundleResponse>): void;
        updateBundle(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Updatebundle, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaUpdateBundleResponse>): void;
        updateBundle(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaUpdateBundleResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        validate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Validate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        validate(params?: Params$Resource$Projects$Locations$Products$Integrations$Versions$Validate, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>;
        validate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Validate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        validate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Validate, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>): void;
        validate(params: Params$Resource$Projects$Locations$Products$Integrations$Versions$Validate, callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>): void;
        validate(callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Products$Integrations$Versions$Archive extends StandardParameters {
        /**
         * Required. The version to archive. Format: projects/{project\}/integrations/{integration\}/versions/{version\}
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Products$Integrations$Versions$Deactivate extends StandardParameters {
        /**
         * Required. The version to deactivate. Format: projects/{project\}/integrations/{integration\}/versions/{version\}
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Products$Integrations$Versions$Getbundle extends StandardParameters {
        /**
         * Required. The bundle name.
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Products$Integrations$Versions$Updatebundle extends StandardParameters {
        /**
         * Required. Bundle name
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Products$Integrations$Versions$Validate extends StandardParameters {
        /**
         * Required. The version to validate. Format: projects/{project\}/integrations/{integration\}/versions/{version\}
         */
        name?: string;
